...
object WindowApply {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val socketDataStream: DataStream[String] = env.socketTextStream("172.31.240.181", 888)
    ...
    val windowedStream: WindowedStream[(String, Int), String, TimeWindow] = keyedStream.timeWindow(Time.seconds(30))
