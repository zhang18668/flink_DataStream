...
object App_test {
  def main(args: Array[String]): Unit = {
    ...
    // TODO 2. 整合MQ
    val consu = FlinkUtils.consumerKafkaFlink("out_traffic")

    val stream = env.addSource(consu)
...
//    val fileJsonDS: DataStream[String] = parDS.map(x=>{
//      implicit val formats: AnyRef with Formats = Serialization.formats(NoTypeHints)
//      write(x)
//    })
////    val fileJsonDS: DataStream[String] =
